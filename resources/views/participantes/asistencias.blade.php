...
@section('content')
    <header class="text-center mb-8 md:mb-12 fade-in">
        <h1 class="text-3xl md:text-5xl font-black uppercase tracking-wider neon-text-purple">Tabla de Asistencias</h1>
        <p class="text-black mt-2 text-sm md:text-base">🎯 Los mejores pasadores del torneo</p>
    </header>
            ...
            <table class="w-full text-left">
                <thead class="bg-black/30 text-gray-300 uppercase text-sm tracking-wider">
                    <tr>
                        ...
                        <th class="p-4 text-center font-bold">Asistencias</th>
                    </tr>
                </thead>
                ...
                <div class="p-4 hover:bg-purple-600/20 transition-colors">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-full 
                            {{ $index == 0 ? 'bg-yellow-500/20' : ($index == 1 ? 'bg-gray-500/20' : ($index == 2 ? 'bg-orange-500/20' : 'bg-blue-500/20')) }}">
                        ...
                        <div class="flex-1 flex items-center gap-3">
                            @if($jugador->file_uri)
                                <img src="{{ asset('img/' . $jugador->file_uri) }}" 
                                     alt="{{ $jugador->name }}"
                                     class="w-14 h-14 rounded-full object-cover border-2 border-blue-500 shadow-lg">
                            @else
                                <div class="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 
                            ...
                            <div class="flex-1">
                                ...
                                <span class="inline-block mt-1 px-2 py-0.5 bg-blue-600/30 rounded-full text-xs text-gray-200">
                                    {{ $jugador->equipo_nombre }}
                                </span>
                            </div>
                        </div>

                        <!-- Cantidad de asistencias (destacado) -->
                        <div class="flex-shrink-0">
                            <div class="relative">
                                <div class="w-16 h-16 rounded-full bg-gradient-to-br from-blue-600 to-cyan-600 
                                    flex items-center justify-center shadow-lg border-2 border-blue-400/50">
                                    <div class="text-center">
                                        <p class="text-2xl font-black text-white leading-none">{{ $jugador->asi }}</p>
                                        <p class="text-[8px] text-blue-200 uppercase font-bold">asist</p>
                                    </div>
                                </div>
                                <!-- Efecto de brillo -->
                ...
                <div class="flex items-end justify-center gap-2">
                    ...
                    <div class="flex-1 text-center">
                        <div class="bg-gray-500/20 rounded-t-lg p-3 h-20 flex flex-col justify-end">
                            ...
                            <p class="text-xs text-gray-300 font-bold">{{ $jugadoresOrdenados[1]->asi }} asist</p>
                        </div>
                    ...
                    <div class="flex-1 text-center">
                        <div class="bg-yellow-500/20 rounded-t-lg p-3 h-28 flex flex-col justify-end border-2 border-yellow-500/50">
                            ...
                            <p class="text-sm text-yellow-400 font-black">{{ $jugadoresOrdenados[0]->asi }} asist</p>
                        </div>
                    ...
                    <div class="flex-1 text-center">
                        <div class="bg-orange-500/20 rounded-t-lg p-3 h-16 flex flex-col justify-end">
                            ...
                            <p class="text-xs text-orange-300 font-bold">{{ $jugadoresOrdenados[2]->asi }} asist</p>
                        </div>
    ...
    <!-- Estadística adicional (opcional) -->
    <div class="max-w-5xl mx-auto mt-4 px-4 fade-in" style="animation-delay: 0.6s;">
        <div class="glassmorphism rounded-lg p-3 text-center">
            <p class="text-xs text-gray-400">
                💡 <span class="text-gray-300 font-semibold">Dato:</span> Las asistencias representan los pases que terminan en gol
            </p>
        </div>
    </div>
@endsection