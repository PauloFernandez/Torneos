...
@section('content')
    <header class="text-center mb-12 fade-in">
        <h1 class="text-5xl font-black uppercase tracking-wider neon-text-purple">Perfil de {{ Auth::user()->name }}</h1>
    </header>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <div class="max-w-xl text-black">
                        ...
                        <form method="post" action="{{ route('participantes.perfil.update') }}" class="mt-6 space-y-6">
                            @csrf
                            @method('patch')
                            <div>
