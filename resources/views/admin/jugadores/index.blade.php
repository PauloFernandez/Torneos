                                   ...
                                   @forelse ($jugadores as $jugador)
                                        @foreach ($jugador->equipos as $equipo)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    <div class="flex items-center">
                                                        <img src="{{ asset('img/' . $equipo->file_uri) }}" alt="Escudo"
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex items-center space-x-2">
                                                        <a href="{{ route('jugadores.edit', [$jugador, $equipo]) }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="px-6 py-4 text-lg font-semibold text-gray-800 text-center">
                                                No hay jugadores asignados a equipos
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
