<x-app-layout>
    ...
    <form action="{{ route('torneos.store') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
        @csrf
        <!-- Información básica -->
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="inscripcion" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 
                        form-control @error('inscripcion') is-invalid @enderror is-valid" value="{{ old('inscripcion') }}" placeholder="1000">
                </div>
                @error('inscripcion')
                    <span class="invalid-feedback text-red-600">
                        <strong>{{ $message }}</strong>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="valor_cancha" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500
                        ...
                        placeholder="1000" value="{{ old('valor_cancha') }}">
                </div>
                @error('valor_cancha')
                    <span class="invalid-feedback text-red-600">
                        <strong>{{ $message }}</strong>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="premio" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500
                        ...
                        placeholder="1000" value="{{ old('premio') }}">
                </div>
                @error('premio')
                    <span class="invalid-feedback text-red-600">
                        <strong>{{ $message }}</strong>
             ...
             <div>
                ...
                <div>
                    ...
                    class="block w-full pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 
                        form-control @error('reglas_gral') is-invalid @enderror is-valid" value="{{ old('reglas_gral') }}">
                    </textarea>
                </div>
                @error('reglas_gral')
                    <span class="invalid-feedback text-red-600">
            ...
            <div>
                ...
                <div>
                    ...
                    class="block w-full pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 
                        form-control @error('sis_competicion') is-invalid @enderror is-valid" value="{{ old('sis_competicion') }}">
                    </textarea>
                </div>
            ...
            <div>
                ...
                <div>
                    ...
                    class="block w-full pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 
                        form-control @error('requisito_jugador') is-invalid @enderror is-valid" value="{{ old('requisito_jugador') }}">
                    </textarea>
                </div>
            ...
            <div>
                ...
                <div>
                    ...
                    class="block w-full pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 
                        form-control @error('disciplina') is-invalid @enderror is-valid" value="{{ old('disciplina') }}">
                    </textarea>
                </div>
                @error('disciplina')
                    <span class="invalid-feedback text-red-600">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="cantidad_equipos" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500
                        ...
                        placeholder="1000" value="{{ old('cantidad_equipos') }}">
                </div>
            ...
            <div class="flex items-center mt-4">
                <input type="checkbox" name="estado" value="1" @if (old('estado') == 1) checked @endif
