            ...
            <main class="flex-1 overflow-y-auto p-4 bg-gray-50">
                ...
                <div>
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-lg font-semibold text-gray-800">Editar Permiso</h2>
                    </div>

                    <form action="{{ route('admin.sistema.permisos.update', $permiso->id) }}" method="POST" id="userForm" class="space-y-4">
                        @method('PUT')
                        @csrf
                        <!-- Información básica -->
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nombre del permiso</label>
                                <div class="relative">
