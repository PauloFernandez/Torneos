<x-app-layout>
    <x-slot name="header">
    	...
    	<div class="border-b border-gray-200">
      	<nav class="-mb-px flex space-x-8">
        	<button class="border-b-2 border-blue-500 text-blue-600 px-4 py-3 text-sm font-medium">Roles</button>
    ...
    <x-responsive-table>
        ...
        <x-slot name="body">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">{{ $role->users_count }} usuarios</td>
                <!-- Botones -->
                <td class="px-4 py-6 whitespace-nowrap text-sm font-medium flex">
		              <a href="{{ route('admin.sistema.rolesPermiso.edit', $role) }}" class="text-green-600 hover:text-green-900 mr-3">
		              	 <i class="fas fa-edit"></i> Permisos
		             	</a>
                  <a href="{{ route('admin.sistema.roles.edit', $role) }}" class="text-blue-600 hover:text-blue-900 mr-3">
                        <i class="fas fa-edit"></i> Editar
                  </a>
                  <form action="{{ route('admin.sistema.roles.destroy', $role)  }}" method="post"
                        onsubmit="event.preventDefault(); confirmAction(this, 'delete-role')">
                        @csrf
                        @method('delete')
    ...
    <x-confirm-modal name="delete-role" title="Eliminar rol" buttonText="Eliminar">
        ¿Estás seguro de eliminar este rol?<br>
